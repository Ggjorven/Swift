...
#include "VkOutline/Core/Core.hpp"
#include "VkOutline/Core/Events.hpp"

//#include "VkOutline/Renderer/RenderingContext.hpp"
...
namespace VkOutline
{
	...
	struct WindowSpecification
	{
		...
		WindowSpecification(std::string name = "VkOutline Window", uint32_t width = 1280u, uint32_t height = 720u)
	...
	struct WindowData
	{
		...
		WindowData(std::string name = "VkOutline Window", uint32_t width = 1280, uint32_t height = 720)
			: Name(name), Width(width), Height(height)
		{
		}
